...
namespace GitUITests
{
    ...
    public sealed class UserEnvironmentInformationTests
    {
        ...
        {
            var gitString = UserEnvironmentInformation.GetGitVersionInfo("2.21.0.windows.1", new VsrVersion("2.18.0"),
                new VsrVersion("2.21.0"));
        ...
        {
            var gitString = UserEnvironmentInformation.GetGitVersionInfo("2.20.1.windows.1", new VsrVersion("2.18.0"),
                new VsrVersion("2.21.0"));
        ...
        {
            var gitString = UserEnvironmentInformation.GetGitVersionInfo("1.6.5.windows.1", new VsrVersion("2.18.0"),
                new VsrVersion("2.21.0"));
        ...
        {
            var gitString = UserEnvironmentInformation.GetGitVersionInfo(null, new VsrVersion("2.18.0"),
                new VsrVersion("2.21.0"));
